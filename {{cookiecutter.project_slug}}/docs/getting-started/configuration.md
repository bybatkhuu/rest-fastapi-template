...
- For **DEVELOPMENT** with **GPU**: [**`compose.override.dev.gpu.yml`**](https://github.com/{{cookiecutter.repo_owner}}/{{cookiecutter.repo_name}}/blob/main/templates/compose/compose.override.dev.gpu.yml)
...
- For **PRODUCTION** with **GPU**: [**`compose.override.prod.gpu.yml`**](https://github.com/{{cookiecutter.repo_owner}}/{{cookiecutter.repo_name}}/blob/main/templates/compose/compose.override.prod.gpu.yml)
